...
const Solutions = (props: Props) => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <h2 className="text-boablue font-bold text-4xl text-center font-sans mb-5">
        Solutions
      </h2>
      <div className="grid row-gap-8 sm:row-gap-0 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
        <div className="p-8 border-b md:border-r lg:border-r">
          <div className="max-w-md text-center">
            ...
            <h6 className="text-xl text-boablue my-5 font-semibold leading-5 font-sans">
              Track Medication Consumption{' '}
            </h6>
            <p className="mb-3 mt-5 text-md text-gray-900">
        ...
        <div className="p-8 border-b lg:border-r">
          <div className="max-w-md text-center">
            ...
            <h6 className="text-xl text-boablue mb-2 font-semibold leading-5 font-sans">
